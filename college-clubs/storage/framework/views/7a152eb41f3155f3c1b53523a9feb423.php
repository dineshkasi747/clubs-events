<?php $__env->startSection('title', 'Club Broadcast Center - ' . $club->name); ?>
...
<div class="max-w-2xl mx-auto space-y-8">
    ...
    <div class="text-center space-y-2">
        ...
        <h1 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl"><?php echo e($club->name); ?> <span class="text-indigo-400">Broadcast Center</span></h1>
        <p class="text-slate-400 text-sm max-w-lg mx-auto">Inform student users about upcoming events, schedule changes, or registration slots for <?php echo e($club->name); ?>.</p>
    </div>

    <!-- Main Glassmorphic Form Card -->
    <div class="glass rounded-3xl p-8 relative overflow-hidden">
        <form action="<?php echo e(route('president.notifications.send')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-2">
                ...
                <div class="relative rounded-xl shadow-sm">
                    <input 
                        ...
                        required 
                        maxlength="100"
                        value="<?php echo e(old('title', '[' . $club->name . '] New Announcement!')); ?>"
                        placeholder="e.g. [<?php echo e($club->name); ?>] New Event Announced!" 
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="text-xs text-red-400 font-semibold mt-1"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-4 text-indigo-400 flex gap-3 text-xs leading-5">
                ...
                <div>
                    ...
                    This broadcast is delivered to student devices. The FCM data payload will carry the metadata for **<?php echo e($club->name); ?>**, enabling targeted click-actions inside the mobile app.
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\clubs-events\college-clubs\resources\views/president/notifications.blade.php ENDPATH**/ ?>